...
- 카카오톡을 이용한다면 `for_kakao/config.py` 정보를 설정한뒤 `kakaotalkbot_myself.py` 를 실행하세요. 토큰 정보 설정은 별도의 [가이드라인](https://pastoral-mind-1b3.notion.site/189f09124a9880338650ff955c098a6c)을 참조하세요.
